...
import com.android.khurkham.tailanguage.infrastructure.MyAppFragmentFactory;
/**
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu_books1) {
            navigateToSection(AppSection.Menubooks1, true);
        } else if (id == R.id.nav_menu_books2) {
            navigateToSection(AppSection.Menubooks2, true);
        } else if (id == R.id.nav_menu_books3) {
            navigateToSection(AppSection.Menubooks3, true);
        } else if (id == R.id.nav_menu_books4) {
            navigateToSection(AppSection.Menubooks4, true);
        } else if (id == R.id.nav_menu_books5) {
             navigateToSection(AppSection.Menubooks5, true);
        } else if (id == R.id.nav_menu_books6) {
            navigateToSection(AppSection.Menubooks6, true);
        } else if (id == R.id.nav_send) {
            navigateToSection(AppSection.Send, true);
        } else if (id == R.id.nav_share) {
            navigateToSection(AppSection.Share, true);
        }
